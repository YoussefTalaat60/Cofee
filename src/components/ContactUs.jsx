...
const ContactUs = () => {
    return (
        <div className="bg-[#3F181C] py-14 min-h-[100vh]">
                     ...
                     duration-200"
                            ...
                            <div className="my-4">
                                <TextareaAutosize id="message"
                                    required
                                    rows="5" placeholder="Write your message here... " className="w-full p-4 rounded-lg bg-[#3F181C] text-white focus:outline-none
